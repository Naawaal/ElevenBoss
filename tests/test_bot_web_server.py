...
class TestBotWebServer(unittest.IsolatedAsyncioTestCase):
    async def test_web_server_health_check(self):
        ...
        # Mock TCPSite and start_web_server to avoid port binding in tests
        with patch("aiohttp.web.TCPSite") as MockTCPSite:
            ...
            await bot.start_web_server(28591)
            ...
            # Verify routes are registered (2 paths * 2 methods [GET, HEAD] = 4 routes)
