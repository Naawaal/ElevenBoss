-- supabase/migrations/013_update_register_rpc.sql
...
BEGIN
    ...
    FOR v_card_record IN SELECT * FROM jsonb_to_recordset(p_cards) AS x(
        ...
        INSERT INTO player_cards (
            ...
            COALESCE(v_card_record.pac, 50),
            COALESCE(v_card_record.sho, 50),
            COALESCE(v_card_record.pas, 50),
            COALESCE(v_card_record.dri, 50),
            COALESCE(v_card_record.def, 50),
            COALESCE(v_card_record.phy, 50),
            COALESCE(v_card_record.potential, 85),
