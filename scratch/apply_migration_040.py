"""Apply migration 040_evolution_legacy_cap_reconcile.sql via DATABASE_URL (psycopg)."""
...
_MIGRATION = Path(__file__).resolve().parents[1] / "supabase/migrations/040_evolution_legacy_cap_reconcile.sql"
...
def main() -> int:
    ...
    print("Migration 040 applied — evolution legacy cap reconciled.")
    return 0
