"""Apply migration 041_player_age_lifecycle.sql via DATABASE_URL (psycopg)."""
...
_MIGRATION = Path(__file__).resolve().parents[1] / "supabase/migrations/041_player_age_lifecycle.sql"
...
def main() -> int:
    ...
    print("Migration 041 applied — player age lifecycle.")
    return 0
