"""Apply migration 039_weekly_rank_rewards.sql via DATABASE_URL (psycopg)."""
...
_MIGRATION = Path(__file__).resolve().parents[1] / "supabase/migrations/039_weekly_rank_rewards.sql"
...
def main() -> int:
    ...
    print("Migration 039 applied — weekly rank rewards verified.")
    return 0
