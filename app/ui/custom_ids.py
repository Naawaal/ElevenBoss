...
KNOWN_SCOPES = {"locker", "squad", "player", "nav", "lineup", "league", "table", "fixtures", "matchday", "match", "setup", "automation", "schedule", "settings", "admin", "dm_settings", "dm_admin"}
KNOWN_ACTIONS = {"open", "view", "page", "back", "close", "refresh", "help", "formation", "auto", "save", "join", "start", "view_table", "week", "prev", "next", "generate", "run", "recent", "status", "toggle", "run_now", "run_check", "go_schedule", "go_league", "automation", "matchday_run", "automation_check", "enable", "disable", "guild_select", "switch", "channel_game", "channel_match", "role_admin", "league_start"}
