...
_ALLOWED: dict[str, frozenset[str]] = {
    ...
    "assign_xi": frozenset({"RosterFree", "Evolving"}),
    "bench": frozenset({"InXI", "Evolving"}),
    "match_include": frozenset({"RosterFree", "InXI", "Evolving"}),
    ...
    "start_evolution": frozenset({"RosterFree", "InXI"}),
